                ...
                <div key={date}>
                    ...
                    <div className="space-y-3">
                        {groupedEntries[date].map(entry => (
                            ...
                            >
                                <div className="bg-white rounded-xl shadow-md p-4 transition-shadow hover:shadow-lg relative group">
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-x-4 gap-y-2 mt-3">
                                                ...
                                                <ActivityIcon icon="fa-pills" label="SAB Simplex" color="text-purple-600" enabled={entry.sabSimplex} />
